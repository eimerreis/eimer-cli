...
const names = ['configure'] as const
...
const metadata: Record<GeneratedNames, GeneratedCommandMeta> = {
  'configure': {
      ...
      options: {
        'show': { type: 'z.coerce.boolean.default', required: true, hasDefault: true, default: false, description: 'Show current config', short: 's', schema: {"type":"zod","method":"default","args":[{"type":"unknown","raw":{"type":"BooleanLiteral","start":610,"end":615,"loc":{"start":{"line":19,"column":44,"index":610},"end":{"line":19,"column":49,"index":615}},"value":false}}]}, validator: '(val) => true' },
        'reset': { type: 'z.coerce.boolean.default', required: true, hasDefault: true, default: false, description: 'Delete config file', short: 'r', fileType: 'file', schema: {"type":"zod","method":"default","args":[{"type":"unknown","raw":{"type":"BooleanLiteral","start":733,"end":738,"loc":{"start":{"line":23,"column":45,"index":733},"end":{"line":23,"column":50,"index":738}},"value":false}}]}, validator: '(val) => true' },
        'key': { type: 'z.enum.optional', required: false, hasDefault: false, description: 'Config key to set', short: 'k', schema: {"type":"zod","method":"optional","args":[]}, validator: '(val) => true' },
        'value': { type: 'z.string.optional', required: false, hasDefault: false, description: 'Config value to set; empty string clears', short: 'v', schema: {"type":"zod","method":"optional","args":[]}, validator: '(val) => true' }
      },
